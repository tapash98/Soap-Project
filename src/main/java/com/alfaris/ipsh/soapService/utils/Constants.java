...
Prod_1.0.0	               			 
*****************************************************************************/
package com.alfaris.ipsh.soapService.utils;
...
public class Constants {
	...
	public final static String PROCESSD = "PROCESSED";
	...
	public static List<String> statusList() {
		...
		statusList.add(MESSAGE_STATUS.PROCESSD);
	...
	public final static String USER_LOG_PDF_NAME = "Parking Slot Report";
